    ...
    <div class="position-sticky">
        <div class=" nav-act list-group list-group-flush mx-3 mt-4">
            ...
            <a href="manage_movies.php"
                class="list-group-item list-group-item-action py-2 my-2 ripple" aria-current="true">
                <i class="fas fa-film me-3"></i><span>Manage Movies</span>
            </a>
            <a href="manage_schedule.php"
                class="list-group-item list-group-item-action py-2 my-2 ripple">
                <i class="fa-solid fa-calendar-days me-3"></i><span>Manage Schedule</span>
            </a>
            <a href="manage_news.php"
                class="list-group-item list-group-item-action py-2 my-2 ripple">
                <i class="fa-solid fa-microphone-lines me-3"></i><span>Manage News</span>
            </a>
