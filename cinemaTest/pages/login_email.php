    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form login-form">
                <form action="login_email.php" method="POST" autocomplete="">
                    ...
                    <div class="form-group my-4">
                        <input class="form-control button" type="submit" name="loginWithEmail" value="Login">
                    </div>
                    <div class="text-center my-4">
                        <a class="btn btn-warning" href="login_user.php">Login by username</a>
                    </div>
