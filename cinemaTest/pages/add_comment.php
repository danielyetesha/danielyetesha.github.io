...
if(isset($_POST['add_comment'])){
    ...
    if(!$result){
        ...
        $detail= $_SESSION['account_type']." whose account id is ". $account_id ." and name ".$_SESSION['username']." commented on the movie title called ".$movie_title.". and the comment say that -- ".$comment." --";
mysqli_query($connection,"INSERT INTO log_file(Account_id,Action,Detail) VALUES ('$account_id','Comment on movie','$detail')") or die(mysqli_error($connection)) or die(mysqli_error($connection));
